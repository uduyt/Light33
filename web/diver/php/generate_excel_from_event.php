...
header("Content-Disposition: attachment; filename=" . str_replace(" ","_",$event_name) . ".xls");  
...
//start while loop to get data
    while($row = mysqli_fetch_row($result))
    {
		...
		$schema_insert = str_replace("á", "a", $schema_insert);
        $schema_insert = str_replace("é", "e", $schema_insert);
        $schema_insert = str_replace("í", "i", $schema_insert);
        $schema_insert = str_replace("ó", "o", $schema_insert);
        $schema_insert = str_replace("ú", "u", $schema_insert);
        $schema_insert = str_replace("ñ", "n", $schema_insert);
		$schema_insert = str_replace("Á", "A", $schema_insert);
        $schema_insert = str_replace("É", "E", $schema_insert);
        $schema_insert = str_replace("Í", "I", $schema_insert);
        $schema_insert = str_replace("Ó", "O", $schema_insert);
