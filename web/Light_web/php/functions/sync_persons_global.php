<?php 
		...
		$persons_result = $mysqli->query("SELECT id, username, lights FROM usuarios WHERE part_schools=0 AND id IN (SELECT user_id FROM analytics_basic) ORDER BY lights DESC");
